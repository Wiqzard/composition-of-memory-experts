...
from src.utils.torch_utils import freeze_model
from src.utils.print_utils import suppress_warnings
...
class SharedVideoMetricModelRegistry(nn.ModuleDict):
    ...
    METRIC_TO_MODELS: Dict[VideoMetricType, List[VideoMetricModelType]] = {
        ...
        VideoMetricType.DINOV2_LAST_FRAME_SIMILARITY: [
            VideoMetricModelType.DINOV2,
        ],
    }
